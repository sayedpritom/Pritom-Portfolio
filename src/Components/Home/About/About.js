    ...
    return (
        <div id="about" className="my-5">
            <div className="relative flex items-center justify-center my-20">
                <h1 className='about-outline uppercase text-9xl text-white font-extra-bold'>About</h1>
                <h2 className='absolute uppercase font-bold text-4xl text-primary'>About Me</h2>
            </div>
            <div>
                <div class="card lg:card-side">
                    ...
                    <div class="card-body text-left text-gray-600 font-normal leading-8">
                        ...
                        <div class="card-actions">
                            <button class="btn btn-outline btn-primary my-3"><a href='https://docs.google.com/document/d/1L4_rjqGeM9qeIDjgEf0ouU7gQnYoo49zP-wQlKXzylY/edit#heading=h.ofli7lu20jj5' target="_blank">Download Resume</a></button>
                        </div>
                    </div>
                </div>
            </div>
